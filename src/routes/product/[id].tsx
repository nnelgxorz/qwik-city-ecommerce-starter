...
import { DocumentHead, EndpointHandler, useEndpoint, useLocation } from "@builder.io/qwik-city";
    ...
    <Async
      ...
      onResolved={(data) =>
        <>
          ...
          <form method="post">
            <label>
              <input type="text" name="id" readOnly hidden aria-hidden="true" value={data?.id} />
            </label>
            <label>
              Made For
